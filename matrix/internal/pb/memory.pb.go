...
const file_memory_proto_rawDesc = "" +
	"\n" +
	"\fmemory.proto\x12\x02pb\"<\n" +
	"\x06Memory\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x04R\x05value\x12\x1c\n" +
	"\x04unit\x18\x02 \x01(\x0e2\b.pb.UnitR\x04unit*\x86\x01\n" +
	"\x04Unit\x12\x14\n" +
	"\x10UNIT_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bUNIT_BIT\x10\x01\x12\r\n" +
	"\tUNIT_BYTE\x10\x02\x12\x12\n" +
	"\x0eUNIT_KILLOBYTE\x10\x03\x12\x11\n" +
	"\rUNIT_MEGABYTE\x10\x04\x12\x11\n" +
	"\rUNIT_GIGABYTE\x10\x05\x12\x11\n" +
	"\rUNIT_TERABYTE\x10\x06BQ\n" +
	"\x06com.pbB\vMemoryProtoP\x01Z\x12matrix/internal/pb\xa2\x02\x03PXX\xaa\x02\x02Pb\xca\x02\x02Pb\xe2\x02\x0ePb\\GPBMetadata\xea\x02\x02Pbb\x06proto3"
